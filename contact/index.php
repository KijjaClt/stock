                  ...
                  <table class="table table-striped b-t text-sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <p><?= $row["contact_name"]." ". $row["contact_lastname"]; ?></p>
                        </td>
                        <td>
                        ...
                        <td>
                          <p><?= ($row["contact_type"] == 1 ? '<label class="label bg-success m-l-xs">ลูกค้า</label>' : '<label class="label bg-primary m-l-xs">คู่ค้า</label>'); ?></p>
                        </td>
                        <td>
                          <a href="edit.php?id=<?= $row["contact_id"]; ?>" class="btn btn-sm bg-warning"><i class="icon-pencil"></i></a>
                          <a href="#" onclick='confirmDelete(<?= $row["contact_id"]; ?>)' class="btn btn-sm bg-danger"><i class="icon-trash"></i></a>
                        </td>
                      </tr>
                      <?php $i++; }} ?>
                    </tbody>
